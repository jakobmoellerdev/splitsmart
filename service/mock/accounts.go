...
import (
	...
	service "github.com/jakobmoellerdev/splitsmart/service"
...
func (m *MockAccounts) Create(ctx context.Context, username string, password []byte) (service.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAccountsMockRecorder) Create(ctx, username, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockAccounts)(nil).Create), ctx, username, password)
}
