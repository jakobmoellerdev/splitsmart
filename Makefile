...
OAPI_CODEGEN_VERSION ?= $(shell awk '/github\.com\/deepmap\/oapi-codegen\/v2/ {print substr($$2, 2)}' go.mod)
OAPI_CODEGEN = $(LOCALBIN)/oapi-codegen
.PHONY: oapi-codegen
oapi-codegen: $(OAPI_CODEGEN) ## Download mockgen locally if necessary.
$(OAPI_CODEGEN): $(LOCALBIN)
	GOBIN=$(LOCALBIN) go install github.com/deepmap/oapi-codegen/v2/cmd/oapi-codegen@v$(OAPI_CODEGEN_VERSION)